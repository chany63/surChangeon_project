  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-d9f7"><div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="container">
          ...
          if (array_key_exists("search_keyword", $_POST)) {  // array_key_exists() : Checks if the specified key exists in the array
              ...
              $query =  $query . " where emp_name like '%$search_keyword%'";
          ...
          <table class="table table-striped table-bordered">
              ...
              while ($row = mysqli_fetch_array($res)) {
                  ...
                  echo "<td width='17%'>
                      <a href='team_form.php?emp_no={$row['emp_no']}'><button class='button primary small'>수정</button></a>
                       <button onclick='javascript:deleteConfirm({$row['emp_no']})' class='button danger small'>삭제</button>
                      </td>";
                  echo "</tr>";
                  $row_index++;
              }
          ...
          <center><div><h4><a href = 'team_form.php'>직원 등록</a></h4></div></center>
          <script>
              function deleteConfirm(emp_no) {
                  if (confirm("정말 삭제하시겠습니까?") == true){    //확인
                      window.location = "team_delete.php?emp_no=" + emp_no;
                  }else{   //취소
                      return;
                  }
              }
